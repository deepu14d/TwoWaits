...
def run_bot():
    ...
    try:
        ...
        if 'hello' in command:
            ...
            print('I am Ash , your virtual assistant master')
            engine_talk('I am Ash , your virtual assistant master. how can i help you ??')
        elif 'how are you' in command:
            print('I am good. Hope you are fine too.')
            engine_talk('I am good. Hope you are also good. How can I help you today?')
            ...
            name = command.replace('draw', '')
            print("You can draw here")
            engine_talk("Redirecting... You can draw there")
            webbrowser.open_new('https://aggie.io/_01gdf82va')
...
print('\n')
print("hello, i am Ash  how can i help you ??")
engine_talk("hello i am Ash  how can i help you ")
